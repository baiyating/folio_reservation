  ...
  renderHealthSummary() {
    ...
    return (
      <FormattedMessage
        ...
        id="ui-shl-reading-rules.example-page.health-summary"
      />
    );
  }
      ...
      <Paneset static>
        <Pane defaultWidth="20%" paneTitle="Examples">
          ...
          <div data-test-example-page-home>
            <Link to="shlcirculation-rules">home page</Link>
          </div>
        </Pane>
        <Pane defaultWidth="80%" paneTitle="Some Stripes Components">
          ...
          <Headline
            ...
            margin="medium"
          >
            <FormattedMessage id="ui-shl-reading-rules.example-page.sample-request" />
          </Headline>
